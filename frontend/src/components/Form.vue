          ...
          <form @submit.prevent="handleSubmit">
            ...
            <div>
              <select v-model="user.portfolio_pref[0][0]" name="portPref1.1" required class="formInputs">
                ...
                ].includes(user.committee_pref[0])"
                  v-for="option in PortfolioPreferencesCountries" :value="option" :key="option">
                  {{ option }}
                </option>
                <option v-if="[
                  ...
                  v-for="option in PortfolioPreferencesAippm" :value="option" :key="option">
                  {{ option }}
                </option>
              </select>
            </div>
            ...
            <label for="CPref2" class="heading" v-if="user.qualification !== QualificationChoices.HIGH_SCHOOL">Committee
              Preference 2:</label>
            ...
            <label class="heading" v-if="user.qualification !== QualificationChoices.HIGH_SCHOOL">Portfolio Preference 1 (for committee 2)</label>
            <div v-if="user.qualification !== QualificationChoices.HIGH_SCHOOL">
              <select v-model="user.portfolio_pref[1][0]" name="portPref2.1" required class="formInputs">
                ...
                <option v-if="[
                  ...
                  CommitteeChoices.UNHRC,
                  CommitteeChoices.UNSC
                ].includes(user.committee_pref[1])" v-for="option in PortfolioPreferencesCountries" :value="option" :key="option">
                  {{ option }}
                </option>
                <option v-if="[
                  CommitteeChoices.AIPPM,
                  CommitteeChoices.AISM,
                ].includes(user.committee_pref[1])"
                  v-for="option in PortfolioPreferencesAippm" :value="option" :key="option">
                  {{ option }}
                </option>
              </select>
            ...
            <label class="heading" v-if="user.qualification !== QualificationChoices.HIGH_SCHOOL">Portfolio Preference 2 (for committee 2)</label>
            <div v-if="user.qualification !== QualificationChoices.HIGH_SCHOOL">
            ...
            <label class="heading" v-if="user.qualification !== QualificationChoices.HIGH_SCHOOL">Portfolio Preference 3 (for committee 2)</label>
            <div v-if="user.qualification !== QualificationChoices.HIGH_SCHOOL">
            ...
            <label for="CPref3" class="heading" v-if="user.qualification !== QualificationChoices.HIGH_SCHOOL">Committee
              Preference 3:</label>
            <div class="qualColor" v-if="user.qualification !== QualificationChoices.HIGH_SCHOOL">
              <div>
            ...
            <label class="heading" v-if="user.qualification !== QualificationChoices.HIGH_SCHOOL">Portfolio Preference 1 (for committee 3)</label>
            <div v-if="user.qualification !== QualificationChoices.HIGH_SCHOOL">
              <select v-model="user.portfolio_pref[2][0]" name="portPref3.1" required class="formInputs">
                ...
                <option v-if="[
                  ...
                  CommitteeChoices.UNHRC,
                  CommitteeChoices.UNSC
                ].includes(user.committee_pref[2])" v-for="option in PortfolioPreferencesCountries" :value="option" :key="option">
                  {{ option }}
                </option>
                <option v-if="[
                  CommitteeChoices.AIPPM,
                  CommitteeChoices.AISM,
                ].includes(user.committee_pref[2])"
                  v-for="option in PortfolioPreferencesAippm" :value="option" :key="option">
                  {{ option }}
                </option>
              </select>
            ...
            <label class="heading" v-if="user.qualification !== QualificationChoices.HIGH_SCHOOL">Portfolio Preference 2 (for committee 3)</label>
            <div v-if="user.qualification !== QualificationChoices.HIGH_SCHOOL">
            ...
            <label class="heading" v-if="user.qualification !== QualificationChoices.HIGH_SCHOOL">Portfolio Preference 3 (for committee 3)</label>
            <div v-if="user.qualification !== QualificationChoices.HIGH_SCHOOL">
